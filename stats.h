...
namespace CISP430_A1
{
    ...
    public:
        ...
        double sum( ) const { return total; } // finds the sum in the sequence of numbers 
        double mean( ) const;                 // finds the mean in the sequence of numbers 
        double minimum( ) const;              // finds the minimum in the sequence of numbers 
        double maximum( ) const;              // finds the maximum in the sequence of numbers   
        // FRIEND FUNCTIONS
